        ...
        // 3. Define the output element
        const outputDiv = document.getElementById("output");
        
        // 4. Function to try fetching with different proxies
        async function fetchWithProxies() {
            ...
            for (const proxy of proxies) {
                try {
                    outputDiv.textContent = `Fetching data using ${proxy}...`;
        ...
        // 5. Function to process the XML data and convert to JSON
        function processData(xmlData) {
            ...
            entries.forEach((entry, index) => {
                try {
                    ...
                    if (content) {
                        // Method 1: Enhanced content parsing
                        console.log("Raw content for debugging:", content);
                        
                        // First attempt: Try creating a temporary div and setting innerHTML to extract image
                        try {
                        ...
                        console.log(`Post ${postId} image extraction:`, { 
                            imgSrc, 
                    ...
                    result.posts.push({
                        ...
                        image_url: "",
                        sample_image: "",
                        original_image: "", // Add empty original_image field for error entries
                        page_url: "",
                        published: "",
                        updated: "",
                        tags: [],
        ...
        // 6. Execute the fetch and display results
        fetchWithProxies()
            .then(result => {
                ...
                result.debug = {
                    ...
                    query_params: { tags, page }
                };
                
                outputDiv.textContent = JSON.stringify(result, null, 2);
                
                // Set appropriate content type through meta tag
